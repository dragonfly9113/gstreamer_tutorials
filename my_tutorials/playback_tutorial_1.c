...
/* Forward definitions for the message and keyboard processing functions */
...
int main (int argc, char *argv[]) {
    ...
    /* Set connection speed. This will affect some internal decision of playbin */
    ...
    /* Create a GLib main loop and set to to run */
